...
public class Result {
    ...
    public void updateGraph() {
        ...
        if(type == SWV)
        {
            ...
            ident = String.format("%s: %dHz, %d to %dmV by %dmV,%dmV,%s\n", stringName,op1,op2,op3,op4,op5,range);
        ...
        else if(type == CV)
        {
            ...
            ident = String.format("%s: %d to %dmV at %dmV/s,%d time, %dmV/sample, %s\n", stringName,op2,op3,op1,op4,op5,range);
        ...
        else if(type == ACV)
        {
            ...
            ident = String.format("%s: %d cycles at %dHz with %dmV amplitude, %dmV to %dmV, %dmV incr, %s\n", stringName,op3,op1,op2,op4,op5,op6,range);
            graph.repaint();
        }
        else if(type == LSV)
        {
        ...
        else if(type == CA)
        {
            ...
            ident = String.format("%s: %ds, %ds at %dmV, %ds, %dmV/sample, %d times, %s\n", stringName,op1,op3,op2,op4,op5,op6,range);
